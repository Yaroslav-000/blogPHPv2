        ...
        <section class="flex regi">
            ...
            <form class="flex regi__form" action="/blog_signup.php" method="post" enctype="multipart/form-data">
                <div class="flex regi-form__name">
                    ...
                    <input class="input regi-form-name__inp" type="text" name="name" value="<?php
                ...
                <div class="flex regi-form__pas-1">
                    ...
                    <input class="input regi-form-pas-1__inp" type="password" name="password_1"  value="<?php
                    if (isset($data['password_1'])) echo $data['password_1']; ?>">
                </div>
                <div class="flex regi-form__pas-2">
                    <h3 class="regi-form-pas-2__title">
                        Введите ваш пароль ещё раз
                    </h3>
                    <input class="input regi-form-pas-2__inp" type="password" name="password_2"  value="<?php
                    if (isset($data['password_2'])) echo $data['password_2']; ?>">
                </div>
                ...
                <div class="flex btn-reset regi-form__com">
                    <button class="regi-form-com__btn" name="du_signup" type="submit" >
                        Зарегестрироваться
                    </button>
                </div>
            </form>
